...
export default function SavingThrowsAndSenses({
  characterData,
  handleUpdate,
}: {
  ...
  const handleAddProficiency = () => {
    ...
    handleUpdate("proficiencies.nonWeapon", [
      ...characterData.proficiencies.nonWeapon,
      newItem,
    ]);
  };

  const handleRemoveProficiency = (index: number) => {
    const updated = characterData.proficiencies.nonWeapon.filter(
      (_, i) => i !== index
    );
  ...
  return (
    <section className="w-full">
      <section className=" flex flex-col md:flex-row gap-8 w-full">
            ...
            <div>
              ...
              <h1 className=" border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("traits.visionType", e.target.value)
                  }
            ...
            <div>
              ...
              <h1 className=" border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("traits.listening", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </h1>
            ...
            <div>
              ...
              <h1 className="border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100 ">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("vitals.movement.base", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </h1>
            ...
            <div>
              ...
              <h1 className=" border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("vitals.movement.actual", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </h1>
            ...
            <div>
              ...
              <h1 className="border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100 ">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("vitals.movement.swim", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </h1>
            ...
            <div className=" ">
              ...
              <p className=" border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("traits.detectionSkill", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </p>
            ...
            <div className=" ">
              ...
              <p className="border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100 ">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("traits.resistances", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </p>
            ...
            <div className=" ">
              ...
              <p className=" border-b-2 font-bold tracking-tight text-zinc-800 dark:text-zinc-100">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdate("traits.immunities", e.target.value)
                  }
                  className="w-full bg-transparent outline-none hover:text-zinc-600 focus:text-zinc-500 transition-colors"
                />
              </p>
        ...
        <div className="flex flex-col gap-4 md:max-w-2/3 w-full ">
          ...
          <div className="grid grid-cols-1 gap-2 w-full">
            {characterData.proficiencies.nonWeapon.map(
              (item: NonWeaponProficiency, index: number) => (
                <div
                  key={index}
                  className="items-center rounded border border-black p-1 hover:bg-black/5 dark:hover:bg-white/5 transition-colors relative"
                >
                  <input
                    type="text"
                    value={item.name}
                    onChange={(e) =>
                      handleUpdate(
                        `proficiencies.nonWeapon.${index}.name`,
                        e.target.value
                      )
                    }
                    className="bg-transparent outline-none border-b border-transparent hover:border-zinc-300 focus:border-zinc-800 font-bold"
                  />
                  <div className=" w-min flex flex-col md:flex-row">
                    <div className="flex flex-row items-center gap-1">
                      <label className="text-xs text-nowrap uppercase">Check Mod:</label>
                      <input
                        type="text"
                        value={item.checkModifier || ""}
                        onChange={(e) =>
                          handleUpdate(
                            `proficiencies.nonWeapon.${index}.checkModifier`,
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex flex-row items-center gap-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleUpdate(
                            `proficiencies.nonWeapon.${index}.ram`,
                            e.target.value
                          )
                        }
                    ...
                    <div className="flex flex-row items-center gap-1 mr-8">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleUpdate(
                            `proficiencies.nonWeapon.${index}.roll`,
                            e.target.value
                          )
                        }
                    ...
                    <button
                      ...
                      className="absolute -right-3 md:right-3 top-[40%] md:top-[25%] group-hover:opacity-100 transition-opacity duration-300 w-6 h-6 flex items-center justify-center rounded-full bg-red-100 hover:bg-red-200 text-red-600 font-bold text-lg" 
