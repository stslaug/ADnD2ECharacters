  ...
  return (
    <div className="group flex flex-col border-b border-black/10 last:border-0 hover:bg-black/5 dark:hover:bg-white/5 transition-colors relative">
      <div className="flex flex-row gap-2 items-center p-1 overflow-hidden">
        ...
        {!isExpanded && (
          <div className="hidden lg:flex flex-row gap-3 text-[10px] items-center text-zinc-600 dark:text-zinc-400">
        ...
        <div className="flex flex-row items-center gap-1 shrink-0 ml-auto mr-1">
          <button 
            ...
            className="text-[10px] bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 px-2 py-1 rounded transition-colors whitespace-nowrap"
          >
      ...
      {isExpanded && (
        <div className="flex flex-col gap-3 p-3 bg-zinc-50/50 dark:bg-zinc-900/30 rounded-b">
